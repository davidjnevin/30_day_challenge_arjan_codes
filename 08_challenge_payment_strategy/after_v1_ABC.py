...
class PaymentProcessingStrategy(ABC):
    def __init__(self):
        pass

    @abstractmethod
    def create_payment_type(self, total: Decimal) -> None:
        pass

class PayPalPaymentStrategy(PaymentProcessingStrategy):
    def create_payment_type(self, total: Decimal) -> None:
...
class ApplePaymentStrategy(PaymentProcessingStrategy):
    def create_payment_type(self, total: Decimal) -> None:
...
class CCPaymentStrategy(PaymentProcessingStrategy):
    def create_payment_type(self, total: Decimal) -> None:
        self.total = total
...
class UnKnownPaymentStrategy(PaymentProcessingStrategy):
    def create_payment_type(self, total: Decimal) -> None:
...
def process_payment(payment_type: PaymentProcessingStrategy, total: Decimal) -> None:
    payment_type.create_payment_type(total=total)
